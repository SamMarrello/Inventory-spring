...
import com.example.payroll.repositories.EmployeeModelAssembler;
...
public class EmployeeController {
    ...
    EmployeeController(EmployeeRepository repo, EmployeeModelAssembler employeeModelAssembler) {
